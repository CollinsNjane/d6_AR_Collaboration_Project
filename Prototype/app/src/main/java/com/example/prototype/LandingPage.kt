...
class LandingPage:Fragment(R.layout.landing_page) {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.landing_page, container, false)
        return view
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var btnAcc = getView()?.findViewById<Button>(R.id.btn_accept)
        // getting ImageView by its id
        rImage = getView()?.findViewById(R.id.imageLanding);
